(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("react")) : typeof define === "function" && define.amd ? define(["exports", "react"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.RamonFormSDUDE = {}, global.React));
...
`;
  ...
  const useStateBuilder = (customLogic) => {
    ...
    const initial = "";
    const [fieldsState, setFieldsState] = require$$0.useState(
      () => buildDispatcher(fieldsLogic, "fields", initial)
    );
    const [groupsState, setGroupsState] = require$$0.useState(
      () => buildDispatcher(groupsLogic, "groups", initial)
    );
    const [selectsState, setSelectsState] = require$$0.useState(
      () => buildDispatcher(selectsLogic, "selects", initial)
    );
    const [textareasState, setTextareasState] = require$$0.useState(
  ...
  function Configurations() {
    const [activeTab, setActiveTab] = require$$0.useState("text");
...
`;
  function StarterKit() {
    const [toggle, setToggle] = require$$0.useState(true);
    const [page, setPage] = require$$0.useState("sync");
  ...
  const version = "0.0.1";
  exports2.CheckboxInput = CheckboxInput;
  exports2.DateInput = DateInput;
  exports2.DateTimeInput = DateTimeInput;
  exports2.EmailInput = EmailInput;
  ...
  exports2.StarterKit = StarterKit;
  exports2.TelInput = TelInput;
  exports2.TextInput = TextInput;
  exports2.TextareaInput = TextareaInput;
  exports2.TimeInput = TimeInput;
  exports2.UrlInput = UrlInput;
  exports2.useRamonForm = useRamonForms;
  exports2.version = version;
  Object.defineProperty(exports2, Symbol.toStringTag, { value: "Module" });
}));
//# sourceMappingURL=ramon-form-sdude.umd.js.map
